function outvector=peakpickautothresh(infile)
%%
...
threshdonor=mean(donor)+3*std(donor)
threshacceptor=mean(acceptor)+3*sqrt((std(acceptor))^2);
...
%outpath=strcat(infile2,'peakpick');
